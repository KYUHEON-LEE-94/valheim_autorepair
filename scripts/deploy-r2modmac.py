#!/usr/bin/env python3
"""Install or update UnifiedAutoRepair in the Valheim Unified dev profile."""
...
LOCAL_ID = "local-1789487429427-a86d6189128f5d04"
...
def main():
    ...
    zip_path = f"{PROJECT}/dist/maizz-UnifiedAutoRepair-{version}.zip"
    ...
    with zipfile.ZipFile(zip_path) as archive:
        ...
        dll_path = "plugins/UnifiedAutoRepair/UnifiedAutoRepair.dll"
    ...
    backup = f"{PROFILES_PATH}.before-unified-auto-repair"
